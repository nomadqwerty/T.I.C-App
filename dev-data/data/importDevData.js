...
const conferences = JSON.parse(fs.readFileSync('./conference-simple.json','utf-8'))
const trainings = JSON.parse(fs.readFileSync('./trainings-simple.json','utf-8'))
const departments = JSON.parse(fs.readFileSync('./departments-simple.json','utf-8'))
